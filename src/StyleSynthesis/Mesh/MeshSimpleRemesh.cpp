...
bool MeshSimpleRemesh::remesh(TTriangleMesh &mesh) {
	...
	// clean up
	if (!MeshUtil::cleanUp(mesh)) return false;
	if (!MeshUtil::recomputeNormals(mesh)) return false;

	return true;
}

bool MeshSimpleRemesh::buildEdgeStructure(
...
bool MeshSimpleRemesh::edgeSplit(
	TTriangleMesh &mesh,
	TMeshEdgeSet &edges)
{
...
bool MeshSimpleRemesh::edgeCollapse(
	TTriangleMesh &mesh,
	TMeshEdgeSet &edges)
{
...
bool MeshSimpleRemesh::splitNonManifoldEdges(TTriangleMesh &mesh) {
...
bool MeshSimpleRemesh::edgeFlip(
	TTriangleMesh &mesh,
	TMeshEdgeSet &edges)
{
...
bool MeshSimpleRemesh::edgeSmooth(TTriangleMesh &mesh) {
...
float MeshSimpleRemesh::edgeFlipBenefit(TTriangleMesh &mesh, TMeshEdge &edge) {
...
float MeshSimpleRemesh::faceCosMaxAngle(vec3 p1, vec3 p2, vec3 p3) {
